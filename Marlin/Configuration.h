...
#define STRING_CONFIG_H_AUTHOR "(3dCreationsbyChad, EnderBelt 3-90)" //cd Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0  //STM32G0B1RE_btt
#endif
...
#define CUSTOM_MACHINE_NAME "ENDERBELT 3-90"
...
//#define USE_YMIN_PLUG //cd
//#define USE_ZMIN_PLUG //cd
 ...
 */
#define Z_MIN_PROBE_PIN PC14 // Pin 32 is the RAMPS default //cd
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -10, 10, 0 } //cd
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   20 // Z Clearance for Deploy/Stow //cd was 10
...
#define E_ENABLE_ON 0 //cd For all extruders
...
#define Z_SAFE_HOMING
  ...
  //#define Z_SAFE_HOMING_Y_POINT Y_CENTER  // Y point for Z homing \\cd turned off. belt doesnt need to be centered
#endif
